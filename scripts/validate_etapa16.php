...
/**
 * Validação local HTTP — Etapa 16 Dossiê do Patrocinador / Prestação Comercial
 * Executar: docker exec dcc_app php /var/www/html/scripts/validate_etapa16.php
 */
...
echo "=== VALIDAÇÃO ETAPA 16 — DOSSIÊS / PRESTAÇÃO COMERCIAL ===" . PHP_EOL . PHP_EOL;
$R = new Report();
...
echo PHP_EOL . 'Validação Etapa 16 concluída com sucesso.' . PHP_EOL;
