...
$templates = [
    ...
    'signature_request_sent' => ['Assinatura eletrônica', 'Documentos disponíveis para assinatura', 'Seus documentos contratuais estão prontos para assinatura.', 'Olá, <strong>{{name}}</strong>.<br><br>Seus documentos de assinatura estão disponíveis na sua etapa pública de credenciamento. Acesse o link seguro abaixo, confira todos os documentos obrigatórios e assine cada item pendente.', '✎', 'Assinar documentos', '{{signature_url}}', 'O link é pessoal e abre a página pública do seu processo. Não compartilhe este acesso.'],
    ...
    'collector_access_self_registered' => ['Portal do captador', 'Acesso criado com sucesso', 'Seu usuário foi criado no sistema.', 'Olá, <strong>{{name}}</strong>.<br><br>Seu acesso foi criado com sucesso. Você já pode entrar no portal do captador com seu e-mail e senha.', '✓', 'Acessar portal do captador', '{{portal_url}}', 'Por segurança, nunca compartilhe sua senha ou dados de acesso.'],
