...
<section class="section">
    <div class="container">
        ...
        <form method="get" action="<?= e(app_url('/proposals')) ?>" class="filter-box filter-box--financial">
            <div class="filter-grid filter-grid--financial">
                <div class="filter-q"><label for="q">Busca</label><input type="text" id="q" name="q" class="input" value="<?= e($f('q')) ?>" placeholder="Título, empresa, contato, observações"></div>
                ...
                <div><label for="ftype">Tipo</label>
                    <select id="ftype" name="type" class="input"><option value="">Todos</option>
            ...
            <div class="filter-flags">
                ...
                <div class="filter-checks">
                    <label class="check-inline"><input type="checkbox" name="sent" value="1" <?= !empty($filters['sent'])?'checked':'' ?>> Enviadas</label>
                    <label class="check-inline"><input type="checkbox" name="not_sent" value="1" <?= !empty($filters['not_sent'])?'checked':'' ?>> Não enviadas</label>
                    <label class="check-inline"><input type="checkbox" name="expired" value="1" <?= !empty($filters['expired'])?'checked':'' ?>> Vencidas</label>
